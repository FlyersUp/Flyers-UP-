  ...
  const quoteResult = computeQuote(
    {
      ...
      pricing_version: (bookingRow.pricing_version as string | null) ?? null,
      service_fee_cents: (bookingRow.service_fee_cents as number | null) ?? null,
      convenience_fee_cents: (bookingRow.convenience_fee_cents as number | null) ?? null,
      protection_fee_cents: (bookingRow.protection_fee_cents as number | null) ?? null,
      subtotal_cents: (bookingRow.subtotal_cents as number | null) ?? null,
      demand_fee_cents: (bookingRow.demand_fee_cents as number | null) ?? null,
      fee_total_cents: (bookingRow.fee_total_cents as number | null) ?? null,
      customer_total_cents: (bookingRow.customer_total_cents as number | null) ?? null,
      pro_earnings_cents: (bookingRow.pro_earnings_cents as number | null) ?? null,
      platform_revenue_cents: (bookingRow.platform_revenue_cents as number | null) ?? null,
      charge_model: (bookingRow.charge_model as string | null) ?? null,
    },
    proPricing,
    serviceName,
    proName,
