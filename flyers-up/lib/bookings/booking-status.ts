...
const TRANSITIONS: Record<string, string[]> = {
  ...
  [STATUS.DEPOSIT_PAID]: [STATUS.ON_THE_WAY, STATUS.IN_PROGRESS, STATUS.CANCELLED_BY_CUSTOMER, STATUS.CANCELLED_BY_PRO],
  ...
  deposit_paid: [STATUS.ON_THE_WAY, 'pro_en_route', STATUS.IN_PROGRESS],
