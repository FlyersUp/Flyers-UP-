...
export const NOTIFICATION_TYPES = {
  ...
  RECURRING_REQUEST_NEW: 'recurring.request_new',
  RECURRING_SERIES_APPROVED: 'recurring.series_approved',
  RECURRING_SERIES_DECLINED: 'recurring.series_declined',
  RECURRING_SERIES_COUNTERED: 'recurring.series_countered',
...
export const TYPE_TO_CATEGORY: Record<NotificationType, NotificationCategory> = {
  ...
  [NOTIFICATION_TYPES.RECURRING_REQUEST_NEW]: NOTIFICATION_CATEGORIES.BOOKING,
  [NOTIFICATION_TYPES.RECURRING_SERIES_APPROVED]: NOTIFICATION_CATEGORIES.BOOKING,
  [NOTIFICATION_TYPES.RECURRING_SERIES_DECLINED]: NOTIFICATION_CATEGORIES.BOOKING,
  [NOTIFICATION_TYPES.RECURRING_SERIES_COUNTERED]: NOTIFICATION_CATEGORIES.BOOKING,
...
export const notificationPayloads: Record<NotificationType, Omit<NotificationPayload, 'deepLink'>> = {
  ...
  [NOTIFICATION_TYPES.RECURRING_REQUEST_NEW]: {
    type: NOTIFICATION_TYPES.RECURRING_REQUEST_NEW,
    title: 'New recurring request',
    body: 'A customer requested a recurring schedule.',
    category: NOTIFICATION_CATEGORIES.BOOKING,
    priority: NOTIFICATION_PRIORITIES.IMPORTANT,
    pushEligible: true,
    proOnly: true,
  },
  [NOTIFICATION_TYPES.RECURRING_SERIES_APPROVED]: {
    type: NOTIFICATION_TYPES.RECURRING_SERIES_APPROVED,
    title: 'Recurring plan approved',
    body: 'Your recurring schedule was approved.',
    category: NOTIFICATION_CATEGORIES.BOOKING,
    priority: NOTIFICATION_PRIORITIES.IMPORTANT,
    pushEligible: true,
    customerOnly: true,
  },
  [NOTIFICATION_TYPES.RECURRING_SERIES_DECLINED]: {
    type: NOTIFICATION_TYPES.RECURRING_SERIES_DECLINED,
    title: 'Recurring request declined',
    body: 'The pro declined your recurring request.',
    category: NOTIFICATION_CATEGORIES.BOOKING,
    priority: NOTIFICATION_PRIORITIES.IMPORTANT,
    pushEligible: true,
    customerOnly: true,
  },
  [NOTIFICATION_TYPES.RECURRING_SERIES_COUNTERED]: {
    type: NOTIFICATION_TYPES.RECURRING_SERIES_COUNTERED,
    title: 'Counter proposal',
    body: 'The pro suggested changes to your recurring plan.',
    category: NOTIFICATION_CATEGORIES.BOOKING,
    priority: NOTIFICATION_PRIORITIES.IMPORTANT,
    pushEligible: true,
    customerOnly: true,
  },
  [NOTIFICATION_TYPES.RECURRING_SERIES_PAUSED]: {
    type: NOTIFICATION_TYPES.RECURRING_SERIES_PAUSED,
    title: 'Recurring plan paused',
    body: 'Your recurring plan was paused.',
    category: NOTIFICATION_CATEGORIES.BOOKING,
    priority: NOTIFICATION_PRIORITIES.INFORMATIONAL,
    pushEligible: false,
    customerOnly: true,
  },
  [NOTIFICATION_TYPES.RECURRING_SERIES_RESUMED]: {
    type: NOTIFICATION_TYPES.RECURRING_SERIES_RESUMED,
    title: 'Recurring plan resumed',
    body: 'Your recurring plan is active again.',
    category: NOTIFICATION_CATEGORIES.BOOKING,
    priority: NOTIFICATION_PRIORITIES.INFORMATIONAL,
    pushEligible: false,
    customerOnly: true,
  },
  [NOTIFICATION_TYPES.RECURRING_SERIES_CANCELED]: {
