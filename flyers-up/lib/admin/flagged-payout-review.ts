...
async function enrichBookingRowsToItems(
  ...
  return list.map((raw) => {
    ...
    const payoutRes = resolveProPayoutTransferCents({
      ...
      customer_total_cents: b.customer_total_cents as number | null,
      fee_total_cents: b.fee_total_cents as number | null,
      service_fee_cents: b.service_fee_cents as number | null,
      convenience_fee_cents: b.convenience_fee_cents as number | null,
      protection_fee_cents: b.protection_fee_cents as number | null,
      demand_fee_cents: b.demand_fee_cents as number | null,
      subtotal_cents: b.subtotal_cents as number | null,
      pro_earnings_cents: b.pro_earnings_cents as number | null,
      customer_fees_retained_cents: b.customer_fees_retained_cents as number | null,
      platform_fee_cents: b.platform_fee_cents as number | null,
