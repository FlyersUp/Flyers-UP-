/**
 * POST /api/bookings/[bookingId]/arrive/photo
 * Upload arrival photo for Pro. Returns public URL.
 */
...
export async function POST(
  ...
  const path = `${user.id}/arrival-photos/${id}-${Date.now()}.${ext}`;
  ...
  if (uploadErr) {
    console.error('Arrival photo upload failed', uploadErr);
