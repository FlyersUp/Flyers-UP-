 ...
 *
 * NOTE:
 * This file previously redirected to `/auth`, while `/auth` redirected back to `/signin`,
 * creating an infinite redirect loop that can appear as a white screen in production.
 */
        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex mb-6 bg-gray-100 rounded-xl p-1">
            ...
            <Link
              ...
              className={`flex-1 py-2.5 text-sm font-medium rounded-lg transition-all text-center ${
                role === 'pro' ? 'bg-white text-amber-700 shadow-sm' : 'text-gray-600 hover:text-gray-900'
              }`}
            >
              Service Pro
            </Link>
