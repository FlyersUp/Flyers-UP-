...
export default function CustomerSupportLegalSettingsPage() {
    ...
    <AppLayout mode="customer">
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <Card withRail>
          ...
          <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-3">
            <a
              ...
              href={`mailto:support@flyersup.app?subject=${encodeURIComponent('Flyers Up Support (Customer)')}&body=${encodeURIComponent(message)}`}
            >
            ...
            <Link
              ...
              className="block p-4 border border-border rounded-lg bg-surface hover:bg-surface2 transition-colors"
            >
              <div className="font-medium text-text">Help center / FAQs</div>
              <div className="text-sm text-muted">Answers + common fixes</div>
            </Link>
            <Link className="block p-4 border border-border rounded-lg bg-surface hover:bg-surface2 transition-colors" href="/terms">
              <div className="font-medium text-text">Terms of service</div>
              <div className="text-sm text-muted">View terms</div>
            </Link>
            <Link className="block p-4 border border-border rounded-lg bg-surface hover:bg-surface2 transition-colors" href="/privacy">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/customer/settings/help-support" className="block">
            <Card withRail>
              <Label>HELP CENTER</Label>
              <p className="mt-3 text-sm text-muted">FAQs + contact (customer UI coming next).</p>
            </Card>
          </Link>
          <Link href="/customer/settings/privacy-security" className="block">
            <Card withRail>
              <Label>PRIVACY &amp; SECURITY</Label>
              <p className="mt-3 text-sm text-muted">Password + account controls (customer UI coming next).</p>
            </Card>
          </Link>
        </div>
      </div>
