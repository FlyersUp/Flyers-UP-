    ...
    <Layout title="Flyers Up" showBackButton>
      ...
      {pros.length === 0 ? (
        <div className="bg-surface border border-border rounded-lg p-8 text-center">
          <p className="text-muted/70 mb-2">No professionals available in this category yet.</p>
          <p className="text-sm text-muted/60">Check back soon or try a different category.</p>
        </div>
      ) : (
