  ...
  return (
    <div className={`flex flex-col sm:flex-row gap-8 sm:gap-12 items-stretch ${className}`}>
      ...
      <div className="flex-1 space-y-6 sm:space-y-8">
        <article className="rounded-2xl border-2 border-[#2C2825]/10 bg-white/95 p-5 shadow-sm">
          <p className="text-xs font-semibold uppercase tracking-wide text-[#5F7163] mb-1">Step 1</p>
          <h3 className="text-lg font-semibold text-[#2C2825]">Details confirmed</h3>
          <p className="text-sm text-[#2C2825]/70 mt-1">
            Scope and expectations are captured in writing—no fuzzy handshakes.
          </p>
        </article>
        <article className="rounded-2xl border-2 border-[#2C2825]/10 bg-white/95 p-5 shadow-sm">
          <p className="text-xs font-semibold uppercase tracking-wide text-[#5F7163] mb-1">Step 2</p>
          <h3 className="text-lg font-semibold text-[#2C2825]">Scheduled</h3>
          <p className="text-sm text-[#2C2825]/70 mt-1">
            Time and place live in one thread, synced with your booking.
          </p>
        </article>
        <article className="rounded-2xl border-2 border-[#8FAD84]/45 bg-[#E4ECD9]/60 p-5 shadow-sm">
          <p className="text-xs font-semibold uppercase tracking-wide text-[#B85C38] mb-1">Step 3</p>
          <h3 className="text-lg font-semibold text-[#2C2825]">Protected payment</h3>
          <p className="text-sm text-[#2C2825]/70 mt-1">
