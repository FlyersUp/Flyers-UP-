...
function BookingCard({ b }: { b: BookingItem }) {
  ...
  return (
    <div className="rounded-2xl border border-black/5 bg-white shadow-sm p-4 hover:shadow transition-shadow">
    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-black/5 bg-white shadow-sm p-5">
        <div className="flex items-start gap-4">
          <div className="h-[72px] w-[72px] rounded-full overflow-hidden bg-white border border-black/5 shadow-sm flex items-center justify-center">
            {avatarUrl ? (
                ...
                <Link key={p.id} href={p.href} className="shrink-0 w-[220px]">
                  <div className="rounded-2xl border border-black/5 bg-white shadow-sm p-4 hover:shadow transition-shadow">
                    <div className="flex items-center gap-3">
                      <div className="h-12 w-12 rounded-full overflow-hidden bg-white border border-black/5 flex items-center justify-center">
                        {p.avatarUrl ? (
        ...
        <div className="rounded-2xl border border-black/5 bg-white shadow-sm overflow-hidden">
          {[
            ...
            <Link key={it.href} href={it.href} className="block">
              <div className="flex items-center justify-between px-4 py-3 border-b border-black/5 last:border-b-0 hover:bg-surface2 transition-colors">
